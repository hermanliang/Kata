...
public class StringToInteger {
   ...
   * an environment which could only store integers within the 32-bit signed integer range: [−2^31,
   * 2^31 − 1]. If the numerical value is out of the range of representable values, INT_MAX (2^31 −
