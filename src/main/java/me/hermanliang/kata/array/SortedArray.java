...
public class SortedArray {
   ...
   * the two sorted arrays. The overall run time complexity should be O(log (m+n)). You may assume
   ...
   * that nums1 has enough space (size that is greater or equal to m + n) to hold additional
   * elements from nums2. Example:
   * <p>
