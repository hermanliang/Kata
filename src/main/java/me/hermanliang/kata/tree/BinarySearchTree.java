...
public class BinarySearchTree {
   ...
   * Example 1:
   * <p>
   * Input: root = [6,2,8,0,4,7,9,null,null,3,5], p = 2, q = 8 Output: 6 Explanation: The LCA of
   * nodes 2 and 8 is 6. Example 2:
   * <p>
   * Input: root = [6,2,8,0,4,7,9,null,null,3,5], p = 2, q = 4 Output: 2 Explanation: The LCA of
